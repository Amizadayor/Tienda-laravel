        ...
        <div class="flex flex-wrap">
            <div class="w-full">
                <div class="bg-white rounded-lg shadow-lg">
                    <div class="p-4">
                        <h1 class="text-2xl font-bold">{{ __('Crear Envío') }}</h1>
                        <form action="{{ route('envio.store') }}" method="POST">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" name="direccion_envio" id="direccion_envio" class="w-full rounded-md border-gray-300 py-2 px-3 mt-1" />
