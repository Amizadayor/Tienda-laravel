                        ...
                        <form action="{{ route('inventario.store') }}" method="POST">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div class="mb-4">
                                    ...
                                    <select name="producto_id" id="producto_id" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                                        <option value="" disabled selected>{{ __('Seleccionar producto') }}</option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="cantidad" id="cantidad" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                                </div>
                                <div class="mb-4">
                                    <label for="ultima_actualizacion" class="block font-bold mb-2">{{ __('Última Actualización') }}</label>
                                    <input type="date" name="ultima_actualizacion" id="ultima_actualizacion" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500" required>
                                </div>
                            </div>
