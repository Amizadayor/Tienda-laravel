        ...
        <div class="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
            <form action="{{ route('cliente.store') }}" method="POST" class="space-y-4">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="direccion" class="border p-3 w-full rounded-lg" type="text" name="direccion" :value="old('direccion')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="telefono" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">Teléfono:</label>
                    <x-text-input id="telefono" class="border p-3 w-full rounded-lg" type="text" name="telefono" :value="old('telefono')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="email" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">Email:</label>
                    <x-text-input id="email" class="border p-3 w-full rounded-lg" type="email" name="email" :value="old('email')" required autofocus />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="fecha_nacimiento" class="border p-3 w-full rounded-lg" type="date" name="fecha_nacimiento" :value="old('fecha_nacimiento')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="ciudad" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">Ciudad:</label>
                    <x-text-input id="ciudad" class="border p-3 w-full rounded-lg" type="text" name="ciudad" :value="old('ciudad')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="codigo_postal" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">Código Postal:</label>
                    <x-text-input id="codigo_postal" class="border p-3 w-full rounded-lg" type="text" name="codigo_postal" :value="old('codigo_postal')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="pais" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">País:</label>
                    <x-text-input id="pais" class="border p-3 w-full rounded-lg" type="text" name="pais" :value="old('pais')" required autofocus />
                </div>

                <div class="mb-4">
                    <label for="notas" class="bg-blue-500 text-white rounded-lg px-4 py-2 font-bold cursor-default">Notas:</label>
                    <x-text-input id="notas" class="border p-3 w-full rounded-lg" type="text" name="notas" :value="old('notas')" required autofocus />
                </div>
